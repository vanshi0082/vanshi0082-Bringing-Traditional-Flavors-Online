        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="snacks.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite snacks</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order and Pay</a></li>

                </ul>
            </div>
        </div>
        <?php $ress= mysqli_query($db,"select * from state where rs_id='$_GET[res_id]'");
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure><?php echo '<img src="admin/Res_img/'.$rows['image'].'" alt="State logo">'; ?></figure>
                            </div>
                        </div>
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                <div class="title-row">
                                    <?php echo $item["title"]; ?><a href="snacks.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>">
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php  
									$stmt = $db->prepare("select * from snacks where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post" action='snacks.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>

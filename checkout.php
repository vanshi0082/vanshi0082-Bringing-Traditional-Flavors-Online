...
function sendOrderEmail($email, $subject, $body) {
    $mail = new PHPMailer(true);
    ...
    try {
        ...
        $mail->setFrom('penguinesp20@gmail.com', 'SGFOODS');		 
        $mail->addAddress($email);
        // $mail->addAddress('receiver2@gfg.com', 'Name');
        $mail->isHTML(true);								 
        $mail->Subject =$subject;
        $mail->Body = $body;
        $mail->AltBody = 'Hello Mr/Ms/Mrs Your Account has been created successfully.';
        $mail->send();
...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
            ...
            $query = "SELECT email FROM users WHERE u_id = '$user_id'";
            ...
            $item_total = 0;
                ...
                $order_details .= "<tr>
                    ...
                    $SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
                        ...
                        $subject = "Order Confirmation - Your Order with Online Food Ordering System";
                        $body = "<h1>Thank you for your order!</h1>";
                        $body .= "<p>Your order has been placed successfully. Here are the details:</p>";
                        ...
                        $body .= $order_details; // Add the order items to the table
                        $body .= "<tr>
                                    <td colspan='3' style='text-align: right;'><strong>Total</strong></td>
                                    <td><strong>₹" . $item_total . "</strong></td>
                                </tr>
                                </table>";
                        $body .= "<p>We will contact you when your order is on its way.</p>";

                        sendOrderEmail($user_email, $subject, $body);
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="state.php">Choose State</a></li>
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Pick Your favorite Snacks</a></li>

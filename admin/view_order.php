...
?>
                ...
                <body class="fix-header fix-sidebar">
                                                    ...
                                                    <table id="myTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <button type="button" class="btn btn-primary" onClick="window.location.href='all_orders.php'">Back</button>
                                                                    </center>
                                                                </td>
                    ...
                    <!-- <footer class="footer"> © Online  State Food Ordering System </footer> -->

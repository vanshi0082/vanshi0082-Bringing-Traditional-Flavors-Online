...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online State Food Ordering System</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="state.php">State <span class="sr-only"></span></a> </li>
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose State</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Snacks of the Month</h2>
                <p class="lead">Easiest way to order your favourite food among these top 6 Snacks</p>
            </div>
            <div class="row">


                <?php 					
						$query_res= mysqli_query($db,"select * from snacks LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="snacks.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">₹'.$r['price'].'</span> <a href="snacks.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>we've got you covered with variety of snacks from different Indian states.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose  Snacks</h3>
                            <p>Discover a diverse array of snacks from across the states of India.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="restaurant-listing">
                    ...
                    <?php  
						$ress= mysqli_query($db,"select * from state");  
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="snacks.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="State logo"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="snacks.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
